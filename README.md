# DS3ConnectionInfo
Simple console program showing active P2P connection information along ping and geolocation for Dark Souls III. In a game whose PvP is highly dependent on spacing and timing, knowing the latency between you and your opponent before the fight can be pretty useful. Also implements a simple in-game overlay (**windowed or borderless windowed mode only, check `settings_readme.txt` for more information**).

## [Download](https://github.com/tremwil/DS3ConnectionInfo/releases/download/V3.2/DS3ConnectionInfo-V3.2.zip)
